...
def upgrade() -> None:
    ...
    sa.Column('preferred_gender', sa.Enum('male', 'female', 'other', name='genderenum'), nullable=False),
    sa.Column('preferred_city', sa.String(), nullable=True),
    sa.Column('invited_by_user_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['invited_by_user_id'], ['public.user.id'], name=op.f('fk_user_invited_by_user_id_user')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_user')),
    schema='public'
    )
    op.create_table('behavior_ratings',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['public.user.id'], name=op.f('fk_behavior_ratings_user_id_user')),
    ...
    op.create_table('combined_ratings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('score', sa.Float(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['public.user.id'], name=op.f('fk_combined_ratings_user_id_user')),
    ...
    sa.ForeignKeyConstraint(['user1_id'], ['public.user.id'], name=op.f('fk_conversation_user1_id_user')),
    sa.ForeignKeyConstraint(['user2_id'], ['public.user.id'], name=op.f('fk_conversation_user2_id_user')),
    ...
    sa.ForeignKeyConstraint(['from_user_id'], ['public.user.id'], name=op.f('fk_likes_from_user_id_user')),
    sa.ForeignKeyConstraint(['to_user_id'], ['public.user.id'], name=op.f('fk_likes_to_user_id_user')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_likes')),
    schema='public'
    )
    op.create_table('primary_ratings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('completeness_score', sa.Float(), nullable=False),
    sa.Column('photo_score', sa.Float(), nullable=False),
    sa.Column('preference_match_score', sa.Float(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['public.user.id'], name=op.f('fk_primary_ratings_user_id_user')),
